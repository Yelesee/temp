export default {
  'app.login.userName': 'نام کاربری',
  'app.login.password': 'کلمه عبور',
  ...
  'app.login.remember-me': 'مرا به خاطر بسپار',
  'app.login.forgot-password': 'رمز عبور خود را فراموش کرده اید؟',
  'app.login.sign-in-with': 'ورود با',
  'app.login.signup': 'ثبت نام کن',
  'app.login.login': 'ورود',
